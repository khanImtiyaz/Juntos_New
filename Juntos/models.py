...
class ProductsManagement(models.Model):
    ...
    insured_amount = models.FloatField('Insured Amount', blank=True,null=True,default=0)
    product_weight = models.FloatField('Product Weight', blank=True,null=True,default=0)
    product_height = models.FloatField('product_height', blank=True,null=True,default=0)
    product_depth = models.FloatField('Product depth', blank=True,null=True,default=0)
    product_width = models.FloatField('Product Width', blank=True,null=True,default=0)
