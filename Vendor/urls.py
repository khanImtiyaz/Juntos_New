...
urlpatterns = [
	...
	url(r'^vendor/profile_view/$', views.ProfileView.as_view(), name='vendor-profile-view'),
	url(r'^update-profile/$', views.UpdateProfile.as_view(), name='vendor-update-profile'),
	url(r'^products/$', views.ProductList.as_view(), name='product-list'),
	url(r'^add-product/$', views.AddProduct.as_view(), name='add-product'),
	url(r'^notification/$', views.AddNotification.as_view(), name='notifications'),
	...
	url(r'^remove-product/$', views.RemoveProduct.as_view(), name="remove-product"),
	url(r'^sellingchart/(?P<query>[a-z]+)$', views.SellingChart.as_view(), name="selling-chart"),
	url(r'^order-history/$', views.OrderHistory.as_view(), name="orders-history"),
	...
	# url(r'^order-invoice/$', invoice_order, name="invoice_order"),
	...
	url(r'^vendor/view-order/$', views.ViewOrder.as_view(), name='view-order'),
